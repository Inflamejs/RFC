...
through a bit of a design process and produce a consensus among Inflame core team.

The "RFC" (request for comments) process is intended to provide a
consistent and controlled path for new features to enter Inflame.

[Active RFC List](https://github.com/inflamejs/rfcs/pulls)

## When you need to follow this process

You need to follow this process if you intend to make "substantial"
changes to Inflmae or its documentation. What constitutes a
...
include the following.
   ...
   - The introduction of new idiomatic usage or conventions, even if they
     do not include code changes to Inflame itself.
...
In short, to get a major feature added to Inflame, one must first get the
RFC merged into the RFC repo as a markdown file. At that point the RFC
is 'active' and may be implemented with the goal of eventual inclusion
into Inflame.

* Fork the RFC repo http://github.com/inflamejs/rfcs
...
[Inflame's official Twitter account](https://twitter.com/inflamejs) will post a
...
**Inflames's RFC process owes its inspiration to the [Rust RFC process] and the EmberJS Core Team**

[Rust RFC process]: https://github.com/rust-lang/rfcs
[EmberJS core team]: http://emberjs.com/team/
